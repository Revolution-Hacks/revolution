<script>
  ...
  let glossary = {
    ...
    'data processing agreement': 'the agreement between us and a third party that states their rights and obligations to us and to you concerning the protection of personal data',
...
<Page title="Privacy Policy">
  ...
  <p>
    We store and process your data with various third-party services.
    Here are some of our third-party services and their {@render term('data processing agreement')}s:
  </p>
  <ul>
  ...
  <p>
    ...
    We take your personal information seriously, and our team members only have access to the data they need
